...
semantics remain authoritative in the [Data Protocol](./data-protocol/README.md).
...
- scope and versions: [`data-protocol/README.md`](./data-protocol/README.md);
- identity, row splitting, stable IDs, assets, combinations, regimens, and
  references: [`entities-and-rows.md`](./data-protocol/entities-and-rows.md);
- evidence thresholds, field entry, dates, sources, statuses, and registry
  promotion: [`source-and-entry-policy.md`](./data-protocol/source-and-entry-policy.md);
- generated artifacts: [`generated-output-contract.md`](./data-protocol/generated-output-contract.md);
- unrepresentable structures: [`edge-cases.md`](./data-protocol/edge-cases.md).
