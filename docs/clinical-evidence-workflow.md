...
the [Clinical Evidence contract](./clinical-evidence/README.md).

## 1. Run Company/Pipeline Research first

Execute the complete [Company/Pipeline workflow](./research-workflow.md) in the
...
Apply the [Clinical Evidence contract](./clinical-evidence/README.md) for Study,
