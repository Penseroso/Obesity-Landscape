...
- Editable Company/Pipeline data (`data/companies/`), the controlled
  ...
  their existing `data/` paths; their physical relocation, and any related
  data-path or generated-sink reconfiguration, belong to the post-Module-8 D4
  execution module.
...
no generated byte, ordering, validation rule, or command name changed.
